...
describe("Phase 8 review hardening", () => {
  ...
  it("derives a period grant only from a canonical TEST price with quantity one", () => {
    ...
    expect(subscriptionGrantForPaidLine(CONTROLLED_LAUNCH_TEST_SUBSCRIPTION_PRICE_IDS.plus_monthly, 1))
      .toMatchObject({ planId: "plus_monthly", quantity: 1, credits: 30 });

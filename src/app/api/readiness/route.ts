...
export async function GET(request: Request) {
  ...
  const phase6Ready=phase6?.ready===true && phase6.schemaVersion==="20260901185200";
  ...
  return apiOk(context,{status:ready?"ready":"not_ready",checks,missing,phase6:phase6?{ready:phase6Ready,schemaVersion:phase6.schemaVersion,balanceLotMismatches:phase6.balanceLotMismatches,deletionReconciliationPending:phase6.deletionReconciliationPending}:null},ready?200:503,{"cache-control":"no-store"});
}

...
The integration never sends document text, extracted text, edited output, C2PA manifests, hashes/receipts, credentials, auth tokens, payment data, or raw account identifiers. Delivery is short-timeout and fail-open so a PulseAtlas outage cannot block inspection or cleaning.

...
export default function PricingPage() {
  return <main className="shell">
    <header className="section-heading"><div><p className="eyebrow">Pricing</p><h1>Pay for successful cleaning work, not scanning.</h1><p>Scanning is free. New guests can receive 2 promotional credits on their first clean, and a real account can claim 3 additional signup credits once. Credits do not expire under normal use.</p></div><a href="/">Back to workbench</a></header>
